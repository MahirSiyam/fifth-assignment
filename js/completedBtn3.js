document.getElementById("completed-btn3").addEventListener("click" , function(event){
    ...
    const completedButton = document.getElementById("completed-btn3");
    completedButton.disabled = true;
    alert("Board updated successfully");
    checkPoint.innerText = '26' ;
    taskAssignedPoint.innerText = '03';  
    
    const notificationMassage = document.getElementById("notification-massage");
    const card1 = document.getElementById("card-3");
